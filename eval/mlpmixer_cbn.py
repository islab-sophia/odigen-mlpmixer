...
class MLPCBNBlock(nn.Module): # MLPMixerLayer
...
class MLPCBNMixer(nn.Module): # MLPMixerBlock
...
class MLPCBNDoubleDepthWiseBlock(nn.Module): # DepthwiseLayer
    def __init__(self,channel,kernel=3,single=False,**kwargs):
        ...
        self.module1 = DepthwiseConvModule(channel,kernel,single=single)
...
if __name__ == '__main__':
    ...
    module = MLPCBNDepthWiseMixer(16,layer=4,single=False).cuda()
    out = module(inp,id)
    print(out[0].shape)